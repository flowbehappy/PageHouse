...
option(USE_INTERNAL_PROTOBUF_LIBRARY "Set to FALSE to use system protobuf instead of bundled. (Experimental. Set to FALSE on your own risk)" 1)

if(NOT EXISTS "${PageHouse_SOURCE_DIR}/contrib/protobuf/cmake/CMakeLists.txt")
...
if(NOT EXTERNAL_PROTOBUF_LIBRARY_FOUND)
  if(NOT MISSING_INTERNAL_PROTOBUF_LIBRARY)
    set(Protobuf_INCLUDE_DIR "${PageHouse_SOURCE_DIR}/contrib/protobuf/src")
    set(Protobuf_LIBRARY libprotobuf)
    set(Protobuf_PROTOC_EXECUTABLE "$<TARGET_FILE:protoc>")
    set(Protobuf_PROTOC_LIBRARY libprotoc)

    include("${PageHouse_SOURCE_DIR}/contrib/protobuf-cmake/protobuf_generate.cmake")
