...
if (NOT EXISTS "${PageHouse_SOURCE_DIR}/contrib/poco/CMakeLists.txt")
...
elseif (NOT MISSING_INTERNAL_POCO_LIBRARY)
    ...
    list (APPEND Poco_INCLUDE_DIRS
        "${PageHouse_SOURCE_DIR}/contrib/poco/Foundation/include/"
        "${PageHouse_SOURCE_DIR}/contrib/poco/Util/include/"
    )

    if (NOT DEFINED POCO_ENABLE_MONGODB OR POCO_ENABLE_MONGODB)
        set (Poco_MongoDB_FOUND 1)
        set (Poco_MongoDB_LIBRARY PocoMongoDB)
        set (Poco_MongoDB_INCLUDE_DIRS "${PageHouse_SOURCE_DIR}/contrib/poco/MongoDB/include/")
    endif ()

    set (Poco_Data_FOUND 1)
    set (Poco_Data_INCLUDE_DIRS "${PageHouse_SOURCE_DIR}/contrib/poco/Data/include")
    ...
    if (USE_STATIC_LIBRARIES AND USE_INTERNAL_ZLIB_LIBRARY)
        list (APPEND Poco_INCLUDE_DIRS
            "${PageHouse_SOURCE_DIR}/contrib/${INTERNAL_ZLIB_NAME}/"
            "${PageHouse_BINARY_DIR}/contrib/${INTERNAL_ZLIB_NAME}/"
        )
    endif ()
