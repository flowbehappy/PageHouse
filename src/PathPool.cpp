...
//{
//    return StoragePathPool(main_data_paths, latest_data_paths, database_, table_, path_need_database_name_, file_provider);
//}
...
//    return genericChoosePath(pool.listGlobalPagePaths(), path_generator, path_getter, pool.log, log_msg);
//}
//
